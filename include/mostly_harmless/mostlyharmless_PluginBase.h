...
namespace mostly_harmless::internal {
    ...
    private:
        ...
        clap_process_status process(const clap_process* clapProcessContext) noexcept override;
        ...
        [[nodiscard]] bool implementsConfigurableAudioPorts() const noexcept override;
        [[nodiscard]] bool configurableAudioPortsCanApplyConfiguration(const clap_audio_port_configuration_request* requests, std::uint32_t requestsCount) const noexcept override;
        [[nodiscard]] bool configurableAudioPortsApplyConfiguration(const clap_audio_port_configuration_request* requests, std::uint32_t requestsCount) noexcept;
        ...
        core::InitContext m_initContext;
        ...
        std::unique_ptr<core::BusLayout> m_busLayout{ nullptr };
    };
} // namespace mostly_harmless::internal
